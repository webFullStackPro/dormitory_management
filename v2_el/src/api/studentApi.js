...
export default class studentApi {
  ...
  static async find (params) {
    ...
    const response = await mockApi.queryPageSuccessfully(studentApi.students)
    return response.data
  }
