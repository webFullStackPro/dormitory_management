...
const StudentList: React.FC = () => {
  ...
  const columns: TableProps<Student>['columns'] = [
    ...
    {title: '专业名称', dataIndex: 'majorName', key: 'majorName', width: 140},
    ...
    {title: '家庭地址', dataIndex: 'address', key: 'address', width: 160},
  ...
  const onExport = () => {
    ...
    studentApi.find(form.getFieldsValue()).then(data => {
      ...
      for (const d of data.data.list) {
        exportData.push([d.studentNumber, d.name, getGenderText(d.gender), d.birthDate.format('YYYY-MM-DD'), d.majorName, d.grade, d.contactPhone, d.email,
          d.provinceName, d.cityName, d.areaName, d.address, d.enrollmentDate.format('YYYY-MM-DD'), d.graduationDate.format('YYYY-MM-DD')])
      }
