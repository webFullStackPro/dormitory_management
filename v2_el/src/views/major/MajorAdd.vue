  ...
  <div class="pop-dialog-container">
    ...
    <el-form label-position="right" :model="majorForm" :label-width="formLabelWidth" ref="refMajorForm" :rules="rules">
      <el-row>
        ...
        <el-col :span="11">
          <el-form-item label="院系名称" prop="facultyName">
            <el-input v-model="majorForm.facultyName" placeholder="请输入院系名称" maxlength="255"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="学制(年)" prop="duration">
            <el-input-number v-model="majorForm.duration" :min="1" :max="99"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="11">
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        facultyName: [
          { required: true, message: '请选择院系名称', trigger: 'blur' }
        ],
        name: [
